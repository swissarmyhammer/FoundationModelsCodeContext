...
/// Centralized `os.Logger` categories for CodeContextKit.
///
/// All loggers share one subsystem, so `log stream --predicate 'subsystem ==
/// "com.swissarmyhammer.CodeContextKit"'` (or Console.app) surfaces every
...
public enum Log {
    /// Shared subsystem identifier for all CodeContextKit loggers.
    public static let subsystem = "com.swissarmyhammer.CodeContextKit"
