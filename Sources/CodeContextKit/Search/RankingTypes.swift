...
// CodeContextKit's home-grown search/ranking primitives (BM25, RRF, Trigram,
...
///
/// Re-exported so library consumers that used `CodeContextKit.Hit` before
...
/// `RankKit.Signals`.
///
/// Re-exported so library consumers that used `CodeContextKit.Signals`
